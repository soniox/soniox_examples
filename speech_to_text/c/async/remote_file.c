...
int main() {
    ...
    const char *audio_url = "https://soniox.com/media/examples/coffee_shop.mp3";
    ...
    json_object_object_add(create_transcription_data, "audio_url", json_object_new_string(audio_url));
